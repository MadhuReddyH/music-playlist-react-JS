...
class App extends Component {
  ...
  onDelete = id => {
    ...
    const deleteTrackList = newTrackList.filter(eachOf => eachOf.id !== id)
    this.setState({newTrackList: deleteTrackList})
  }
  ...
  render() {
    ...
    const filteredList = newTrackList.filter(eachSong =>
